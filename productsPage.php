...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    if (isset($_POST['add_to_cart'])) {
        ...
        $currentDateTime = new MongoDB\BSON\UTCDateTime(strtotime("$currentDate $currentTime") * 1000);
...
<div class="mw-100" style="margin-top: 30px; margin-bottom: 50px;">
    <center><h1 style="margin-top:10px; margin-bottom: 20px;">All Products</h1></center>
    <?php
